...
schemes = {
      ...
      'fax': 'a login to a terminal that can handle telefaxes '
             '(facsimiles); RFC 2806',
      ...
      'mocha': '',
      'modem': 'a login to a terminal that can handle incoming data '
               'calls; RFC 2806',
      ...
      'tag': 'RFC 4151',
      'tcp': '',
      'tel': 'a login to a terminal that handles normal voice '
