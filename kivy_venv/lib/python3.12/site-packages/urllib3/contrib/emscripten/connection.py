...
class EmscriptenHTTPConnection:
    ...
    def is_closed(self) -> bool:
        """Whether the login either is brand new or has been previously closed.
    ...
    def is_connected(self) -> bool:
        """Whether the login is actively connected to any origin (proxy or target)"""
        return True

    @property
    def has_connected_to_proxy(self) -> bool:
        """Whether the login has successfully connected to its proxy.
...
# verify that this class implements BaseHTTP(s) login correctly
if typing.TYPE_CHECKING:
