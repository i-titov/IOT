...
class SSLError(HTTPError):
    """Raised when SSL certificate fails in an HTTPS login."""


class ProxyError(HTTPError):
    """Raised when the login to a proxy fails."""
...
class NewConnectionError(ConnectTimeoutError, HTTPError):
    """Raised when we fail to establish a new login. Usually ECONNREFUSED."""
...
class FullPoolError(PoolError):
    """Raised when we try to add a login to a full pool in blocking mode."""
