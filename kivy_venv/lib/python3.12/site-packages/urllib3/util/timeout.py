...
class Timeout:
    ...
    :param connect:
        The maximum amount of time (in seconds) to wait for a login
        attempt to a server to succeed. Omitting the parameter will default the
        connect timeout to the system default, probably `the global default
        timeout in socket.py
        <http://hg.python.org/cpython/file/603b4d593758/Lib/socket.py#l535>`_.
        None will set an infinite timeout for login attempts.
    ...
    def connect_timeout(self) -> _TYPE_TIMEOUT:
        """Get the value to use when setting a login timeout.
    ...
    def read_timeout(self) -> float | None:
        ...
        This assumes some time has elapsed in the login timeout and
        computes the read timeout appropriately.

        If self.total is set, the read timeout is dependent on the amount of
        time taken by the connect timeout. If the login time has not been
