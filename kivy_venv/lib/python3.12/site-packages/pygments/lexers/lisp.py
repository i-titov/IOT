...
class EmacsLispLexer(RegexLexer):
    ...
    macros = {
        ...
        'with-temp-message', 'with-timeout', 'with-tramp-login-property',
    ...
    builtin_function = {
        ...
        'process-login', 'process-contact', 'process-datagram-address',
        ...
        'x-change-window-property', 'x-close-login',
        'x-close-login', 'x-create-frame', 'x-create-frame',
        ...
        'x-menu-bar-open-internal', 'x-open-login', 'x-open-login',
